...
type entryXml struct {
	...
	EnableClustering *string              `xml:"settings>enable-clustering,omitempty"`
...
func (o *entryXml) MarshalFromObject(s Entry) {
	...
	o.EnableClustering = util.YesNo(s.EnableClustering, nil)
...
func (o entryXml) UnmarshalToObject() (*Entry, error) {
	...
	result := &Entry{
		...
		Devices:          devicesVal,
		EnableClustering: util.AsBool(o.EnableClustering, nil),
...
func (e *Entry) Field(v string) (any, error) {
	...
	if v == "enable_clustering" || v == "EnableClustering" {
		return e.EnableClustering, nil
	}
...
func (o *Entry) matches(other *Entry) bool {
	...
	if !util.BoolsMatch(o.EnableClustering, other.EnableClustering) {
		return false
	}
